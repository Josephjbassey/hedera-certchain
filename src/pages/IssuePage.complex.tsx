...
import { IPFSService } from '@/features/certificates/services/ipfs.service';
import { CertificateCryptoService } from '@/features/certificates/services/crypto.service';
...
Click OK to open Remix IDE.
  ...
  const handleFileUpload = async (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (uploadedFile) {
      ...
      try {
        ...
        const hash = CertificateCryptoService.generate_certificate_hash(
          {
  ...
  const handleMintNFT = async () => {
    ...
    try {
      ...
      // TODO: Create IPFS service instance and implement upload
      ...
      const metadataUploadResult = { 
        cid: 'temp-metadata-cid',
        url: 'https://temp-metadata-url.com', 
        success: true 
      } as any;
...
- Recipient: ${formData.recipientAddress || accountId}
