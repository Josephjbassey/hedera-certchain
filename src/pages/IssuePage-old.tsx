  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Step 2: Upload image to IPFS
      ...
      setIpfsData(prev => ({
        ...
        metadataHash: metadataUploadResult.hash
      }));

      // Step 4: Mint NFT using the deployed contract
      console.log('🎯 Minting NFT on contract:', deployedContractAddress);
      
      // Here you would use the deployed contract to mint
      // For now, we'll simulate the minting process
      console.log('✅ NFT minted successfully!');
      
      // Simulate minting result
